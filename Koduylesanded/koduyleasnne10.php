...
<body>
    ...
    <form method="POST" action="?">
        ...
        <fieldset>
            ...
            <input type="number" min="0" max="20" step="1" name="bw" id="bw" <?php if(!empty($_POST["bw"])) echo "value=\"". htmlspecialchars($_POST["bw"]) ."\" "; ?>>
            ...
            <br/>
            <input type="number" min="0" max="100" step="1" name="br" id="br" <?php if(!empty($_POST["br"])) echo "value=\"". htmlspecialchars($_POST["br"]) ."\" "; ?>>
